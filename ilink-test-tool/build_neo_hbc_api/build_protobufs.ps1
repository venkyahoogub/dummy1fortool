...
# Resolve Absolute Paths: $PSScriptRoot is root/build_neo_hbc_api
$SCRIPT_DIR = $PSScriptRoot
$ROOT_DIR = Split-Path -Path $SCRIPT_DIR -Parent

# Paths to the .proto file (root/neo_hbc_api/hbc.proto)
$PROTO_DIR = Join-Path $ROOT_DIR "neo-hbc-api"
$PROTO_FILE = Join-Path $PROTO_DIR "hbc.proto"

# Output directories (relative to THIS script in build_neo_hbc_api)
